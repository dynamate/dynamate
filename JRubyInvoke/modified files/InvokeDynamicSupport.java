...
public class InvokeDynamicSupport {
    ...
    public static Handle getInvocationHandle() {
       return new Handle(Opcodes.H_INVOKESTATIC, "library.impl.jruby.Bootstrap".replace('.','/'), "bootstrap", BOOTSTRAP_BARE_SIG);
//        return getBootstrapHandle("bootstrap", "library.Bootstrap".replace('.','/'), BOOTSTRAP_BARE_SIG);
    }
