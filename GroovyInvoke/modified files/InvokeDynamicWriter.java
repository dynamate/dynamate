...
public class InvokeDynamicWriter extends InvocationWriter {
	...
	private static final String INDY_INTERFACE_NAME = "library/impl/groovy/Bootstrap";

	private static final String BSM_METHOD_TYPE_DESCRIPTOR = "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;";
	// MethodType.methodType(
	// CallSite.class, Lookup.class, String.class, MethodType.class
	// ).toMethodDescriptorString();

	private static final Handle BSM = new Handle(H_INVOKESTATIC, INDY_INTERFACE_NAME, "bootstrap", BSM_METHOD_TYPE_DESCRIPTOR);
	private static final Handle BSM_SAFE = new Handle(H_INVOKESTATIC, INDY_INTERFACE_NAME, "bootstrapSafe", BSM_METHOD_TYPE_DESCRIPTOR);
	private static final Handle BSM_CURRENT = new Handle(H_INVOKESTATIC, INDY_INTERFACE_NAME, "bootstrapCurrent", BSM_METHOD_TYPE_DESCRIPTOR);
	private static final Handle BSM_CURRENT_SAFE = new Handle(H_INVOKESTATIC, INDY_INTERFACE_NAME, "bootstrapCurrentSafe", BSM_METHOD_TYPE_DESCRIPTOR);
	...
	@Override
	public void makeCall(Expression origin, Expression receiver, Expression message, Expression arguments, MethodCallerMultiAdapter adapter, boolean safe, boolean spreadSafe,
		...
		if (origin instanceof MethodCallExpression) {
			...
			if (this.writeDirectMethodCall(target, implicitThis, receiver, makeArgumentList(arguments))) {
				return;
			}
		}
	...
	private void makeIndyCall(MethodCallerMultiAdapter adapter, Expression receiver, boolean implicitThis, boolean safe, String methodName, Expression arguments) {
		...
		this.controller.getMethodVisitor().visitInvokeDynamicInsn(methodName, sig, bsmHandle);
